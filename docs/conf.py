...
author = u'Danny Hermes, Google Cloud Platform'
...
release = os.getenv('SPHINX_RELEASE',
                    get_distribution('gcloud_bigtable').version)
...
latex_documents = [
  (master_doc, 'GoogleCloudBigtable.tex', u'Google Cloud Bigtable Documentation',
   u'Danny Hermes, Google Cloud Platform', 'manual'),
]
