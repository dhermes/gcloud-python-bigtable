...
class EarlyAdopterBigtableServiceStub(object):
  ...
  @abc.abstractmethod
  def MutateRows(self, request):
    raise NotImplementedError()
  MutateRows.async = None
  @abc.abstractmethod
...
def early_adopter_create_BigtableService_server(servicer, port, private_key=None, certificate_chain=None):
  ...
  method_service_descriptions = {
    ...
    "MutateRows": alpha_utilities.unary_unary_service_description(
      servicer.MutateRows,
      gcloud_bigtable._generated.bigtable_service_messages_pb2.MutateRowsRequest.FromString,
      gcloud_bigtable._generated.bigtable_service_messages_pb2.MutateRowsResponse.SerializeToString,
    ),
...
def early_adopter_create_BigtableService_stub(host, port, metadata_transformer=None, secure=False, root_certificates=None, private_key=None, certificate_chain=None, server_host_override=None):
  ...
  method_invocation_descriptions = {
    ...
    "MutateRows": alpha_utilities.unary_unary_invocation_description(
      gcloud_bigtable._generated.bigtable_service_messages_pb2.MutateRowsRequest.SerializeToString,
      gcloud_bigtable._generated.bigtable_service_messages_pb2.MutateRowsResponse.FromString,
    ),
...
def beta_create_BigtableService_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
  ...
  request_deserializers = {
    ...
    ('google.bigtable.v1.BigtableService', 'MutateRows'): gcloud_bigtable._generated.bigtable_service_messages_pb2.MutateRowsRequest.FromString,
  ...
  response_serializers = {
    ...
    ('google.bigtable.v1.BigtableService', 'MutateRows'): gcloud_bigtable._generated.bigtable_service_messages_pb2.MutateRowsResponse.SerializeToString,
...
def beta_create_BigtableService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
  ...
  request_serializers = {
    ...
    ('google.bigtable.v1.BigtableService', 'MutateRows'): gcloud_bigtable._generated.bigtable_service_messages_pb2.MutateRowsRequest.SerializeToString,
  ...
  response_deserializers = {
    ...
    ('google.bigtable.v1.BigtableService', 'MutateRows'): gcloud_bigtable._generated.bigtable_service_messages_pb2.MutateRowsResponse.FromString,
