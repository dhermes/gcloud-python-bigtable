...
class TestConnection(unittest2.TestCase):
    ...
    def test_constructor(self):
        ...
        self.assertTrue(connection._credentials._scopes is None)
...
class TestDataConnection(unittest2.TestCase):
    ...
    def test_constructor(self):
        from gcloud_bigtable.connection import DATA_SCOPE

        credentials = _Credentials()
        connection = self._makeOne(credentials=credentials)
        self.assertTrue(connection._credentials is credentials)
        self.assertEqual(connection._credentials._scopes, (DATA_SCOPE,))
        self.assertTrue(connection._http is None)

    def test_build_api_url(self):
        from gcloud_bigtable.connection import DATA_API_BASE_URL
